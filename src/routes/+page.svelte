...
<div class="max-w-6xl mx-auto">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div>
            ...
            <div class="flex mt-4 gap-2">
                {#each product.images as img}
                    <button
                        type="button"
                        class="w-20 h-20 border border-gray-200 rounded overflow-hidden focus:outline-none focus:ring-2 focus:ring-blue-500"
        ...
        <div class="flex flex-col">
            ...
            <!-- 価格 -->
            <div class="mb-4">
                <span class="text-2xl text-red-500 font-bold mr-2"
    ...
    <div class="mt-12">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            {#each related as item}
                <div
                    class="border rounded-lg overflow-hidden shadow hover:shadow-lg transition cursor-pointer p-2"
                >
                    <div class="relative">
                        <img
                            src={item.src}
